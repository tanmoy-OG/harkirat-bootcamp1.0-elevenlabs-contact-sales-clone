...
const Form = () => {
  return (
    <div className="bg-60W text-10B basis-1/2 px-32 pt-5 flex flex-col justify-center">
        <form action="" className='flex flex-col gap-8 mx-auto w-full max-w-[600px]'>
            ...
            <div className="flex justify-between items-center py-6">
                <button className='bg-30B text-60W rounded-full hover:cursor-not-allowed active:scale-98 px-4 py-2.5'>Next</button>
